...
function UpdateProfile({ fetchAgain, setFetchAgain, setModalActive, handleDelete }) {
    ...
    const imageUpload = async (event) => {
        ...
        try {
            ...
            // console.log(`profilePic->${profilePic},profilePic.name->${profilePic.name},formData->${formData},config->${config.headers.Authorization}--->${profilePicUpdateRoute}`)
            ...
            console.log(data.updatedUser.profilePic,"data")
            setUser(data.updatedUser);
            handleLocalStorage(data);
            setFetchAgain(!fetchAgain);
        } catch (error) {
